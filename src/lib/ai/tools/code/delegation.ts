 ...
 * `millionco/repo/extra` or `millionco//x`.
 */
...
function buildPrBody(lastText: string, authorUsername: string | undefined): string {
  ...
  const attribution = safeAuthorUsername
    ? `Generated by \`@${safeAuthorUsername}\` using [Pookie](https://github.com/millionco/pookie)`
    : `Generated by [Pookie](https://github.com/millionco/pookie)`;
